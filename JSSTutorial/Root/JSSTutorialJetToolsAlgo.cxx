...
JSSTutorialJetToolsAlgo :: JSSTutorialJetToolsAlgo ()
{
  ...
  Info("JSSTutorialJetToolsAlgo()", "Calling constructor");
...
EL::StatusCode JSSTutorialJetToolsAlgo :: initialize ()
{
  ...
  Info("initialize()", "JSSTutorialJetToolsAlgo Interface succesfully initialized!" );
  return EL::StatusCode::SUCCESS;
}
...
EL::StatusCode JSSTutorialJetToolsAlgo :: execute ()
{
  ...
  if ( m_debug ) { Info("execute()", "Executing JSSTutorialJetToolsAlgo..."); }
