...
double Transform::calculate_theta_for_rotations(std::map<std::string,double> clusters){
...
void Transform::rotate_about_primary(std::map<std::string,double> &clusters, double angle){
